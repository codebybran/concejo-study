...
const EXAMENES = {
  "1": [
    ...
    {
      "p": "¿Qué tipo de corporación es el Concejo Municipal?",
      "ops": [
        "Judicial",
    ...
    {
      "p": "¿Cuál es el período de los concejales?",
      "ops": [
        "2 años",
        "3 años",
        "4 años",
  ...
  "2": [
    ...
    {
      "p": "¿Qué documento registra lo sucedido en cada sesión?",
      "ops": [
        "El decreto",
        "El acuerdo",
        "El acta",
    ...
    {
      "p": "¿Cuál es la principal decisión del Concejo?",
      "ops": [
        "Decretos",
        "Resoluciones",
        "Acuerdos",
  ...
  "3": [
    {
      "p": "¿Quién preside el Concejo Municipal?",
      "ops": [
        "El Alcalde",
        "El Gobernador",
  ...
  "4": [
    ...
    {
      "p": "¿Los concejales generan vínculo laboral con el municipio?",
      "ops": [
        "Sí, son empleados públicos",
        "No, su función no genera vínculo laboral",
  ...
  "5": [
    ...
    {
      "p": "¿Cuál es una función del Secretario?",
      "ops": [
        "Presidir sesiones",
        "Elaborar el presupuesto municipal",
        "Custodiar documentos y actas del Concejo",
        "Elegir comisionados"
      ],
      "r": 2
    },
  ...
  "6": [
    {
      "p": "¿Cuántos tipos de comisiones existen en el Concejo?",
      "ops": [
        "Solo permanentes",
        "Permanentes, accidentales y especiales",
        "Solo accidentales",
        "Solo especiales"
      ],
      "r": 1
    ...
    {
      "p": "¿Las comisiones permanentes pueden sesionar al mismo tiempo que la plenaria?",
      "ops": [
        "Siempre",
        "Nunca",
        "Solo cuando el reglamento lo permita",
  ...
  "7": [
    ...
    {
      "p": "¿Qué es la moción de censura?",
      "ops": [
        "Una felicitación a un funcionario",
        "Un mecanismo para sancionar políticamente a funcionarios por gestión deficiente",
        "Una solicitud de información",
        "Un tipo de votación secreta"
      ],
      "r": 1
    },
    {
  ...
  "8": [
    {
      "p": "¿Quién puede presentar proyectos de acuerdo?",
      "ops": [
        "Solo el Alcalde",
        "Solo los concejales",
        "El Alcalde, concejales y comunidad según la ley",
        "Solo la comunidad"
      ],
      "r": 2
    },
    {
      "p": "¿Cuántos debates requiere un proyecto de acuerdo?",
      "ops": [
        "Uno",
        "Dos",
        "Tres",
  ...
  "9": [
    {
      "p": "¿Cuántos días tiene el Alcalde para objetar un acuerdo aprobado?",
      "ops": [
        "3 días",
        "5 días",
        "10 días",
    ...
    {
      "p": "¿Qué tipo de objeciones puede hacer el Alcalde?",
      "ops": [
        "Solo por inconveniencia",
        "Por inconveniencia o por razones de derecho (ilegalidad)",
        "Solo por ilegalidad",
  ...
  "10": [
    {
      "p": "¿Qué es el Cabildo Abierto?",
      "ops": [
        "Una sesión privada del Concejo",
        "Una reunión pública donde la comunidad puede participar directamente",
        "Una comisión especial",
        "Una sesión de control político"
      ],
      "r": 1
    },
    {
  ...
  "11": [
    {
      "p": "¿Qué es la oposición política?",
      "ops": [
        "Un partido que pierde elecciones",
        "La función de organizaciones políticas que no apoyan al gobierno de turno",
        "Un movimiento social",
        "Una fracción del Concejo"
      ],
      "r": 1
    },
    {
      "p": "¿Qué ley regula el Estatuto de la Oposición en Colombia?",
      "ops": [
        "Ley 136 de 1994",
        "Ley 1909 de 2018",
        "Ley 974 de 2005",
    ...
    {
      "p": "¿Cuándo debe una organización política declararse en oposición?",
      "ops": [
        "En cualquier momento",
        "Dentro del mes siguiente a la posesión del Alcalde",
        "Al inicio del año",
  ...
  "12": [
    {
      "p": "¿Desde cuándo rige el Acuerdo 024 de 2025?",
      "ops": [
        "Desde enero de 2026",
        "Desde su publicación",
        "Desde el 1 de enero de 2025",
        "Desde la posesión del nuevo Concejo"
      ],
      "r": 1
    },
    {
    ...
    {
      "p": "¿Quién divulga el contenido del nuevo reglamento?",
      "ops": [
        "El Alcalde",
